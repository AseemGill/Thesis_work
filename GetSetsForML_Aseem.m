...
ratnum = 10;
savepath = strcat('Exploration\Aseem\Rat', string(ratnum),'\SetsforML');

disp(savepath)

% [FILENAME, PATHNAME] = uigetfile('Exploration\Aseem\');
% temp = split(FILENAME,'_');

base_dir = strcat('Exploration\Aseem\Rat', string(ratnum),'\')
